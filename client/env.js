...
const BUNDLE_ID = 'arrow.tech'; // ios bundle id
const PACKAGE = 'arrow.tech'; // android package name
const NAME = 'wallpaper-engine'; // app name
const EXPO_ACCOUNT_OWNER = 'ankitdwij'; // expo account owner
const EAS_PROJECT_ID = '6f50f3de-222d-406e-8a2f-3a0c9f8050ef'; // eas project id
const SCHEME = 'arrowTech'; // app scheme
